Ext.define('ItalboxCatalog.store.Languages', {
    ...
    config:{
        ...
        menu_help:  'margin:5px 10px 10px 10px; background: url(imgs/icons/ajuda_menu.png) no-repeat, rgba(255, 255, 255, .4);'+
            'background-size: contain; background-position: center;',
        company_html: '<div class="italbox"><img src="imgs/company.jpg"></img><br/><font color="#b69757">EMPRESA</font><br/><br/>'+
        ...
        'São princípios orientadores da empresa: a Inovação, o Design, a Qualidade, a Personalização e o Serviço, com vista à satisfação do cliente e ao reforço e consolidação da sua posição nos diferentes mercados.<br/><br/>'+
        'Venha conhecer-nos os nossos produtos consultando o site: <font color="#b69757">www.italbox.pt</font><br/><br/>'+
        'Reconhecida pela sua qualidade, capacidade de desenvolvimento e produção personalizada, a ITALBOX está presente em obras de referência, nomeadamente em hotéis e resorts (Portugal, Espanha, França, Cabo Verde, Angola, Moçambique), bem como nos empreendimentos habitacionais mais exigentes.<br/><br/>'+
        'Informamos que estamos ao vosso dispor para esclarecer qualquer dúvida adicional através do email: <font color="#b69757">'+
        'comercial@italbox.pt</font>.</p></div>',
